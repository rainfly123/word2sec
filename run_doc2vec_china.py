...
lee_train_file = 'doc_train'
lee_test_file = 'doc_test'
...
#
# xiecc vector = model.infer_vector(['only', 'you', 'can', 'prevent', 'forest', 'fires'])
# xiecc print(vector)
...
# xiecc import collections

# xiecc counter = collections.Counter(ranks)
# xiecc print(counter)
